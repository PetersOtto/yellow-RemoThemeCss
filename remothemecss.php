...
class YellowRemoThemeCss {
    ...
    public function onParsePageOutput($page, $text) {
        ...
        $output .= str_replace($themeCssFileLink[0],"<!-- The theme CSS link is not needed and was removed from the HTML source code by the Yellow-RemoThemeCss extension. -->", $htmlSource);
        return $output;
    }
}
